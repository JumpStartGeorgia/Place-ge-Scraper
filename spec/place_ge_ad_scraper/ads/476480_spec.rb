test_place_ge_ad(
  ...
  has_network: false,
  has_generator: false,
  additional_information: 'ვიგირავებ ბინას 10000$ ფარგლებში,დიღმის მასივში,ნახალოვკა,სანზონა ან გლდანის ტერიტორიაზე მეტროსთან ახლოს',
  telephone_number: '5-98-008968',
  seller_type: nil,
  seller_name: nil
)
